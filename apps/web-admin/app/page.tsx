    ...
    <div className="p-4 md:p-6 lg:p-8 space-y-6 animate-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-[#1a73e8] hover:bg-[#1557b0] active:bg-[#0d47a1] text-white text-[14px] font-medium px-5 py-2.5 rounded-full shadow-sm transition-all active:scale-95 whitespace-nowrap"
        >
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <span
                ...
                style={{
                  background: kpi.positive ? '#e6f4ea' : '#fce8e6',
                  color: kpi.positive ? '#137333' : '#c5221f',
                }}
              >
                {kpi.change}
              </span>
            ...
            {/* Value */}
            <div className="text-[28px] font-bold text-[#1f1f1f] leading-tight tracking-tight">
              {kpi.value}
            </div>
            {/* Label */}
            <div className="text-[13px] font-medium text-[#3c4043] mt-1">{kpi.label}</div>
            {/* Sub */}
            <div className="text-[12px] text-[#80868b] mt-0.5">{kpi.sub}</div>
          </div>
        ))}
      </div>
